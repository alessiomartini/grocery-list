...
- **Statistiche**: ogni volta che spunti un articolo come comprato viene registrato in una cronologia acquisti separata (sopravvive anche se poi modifichi o elimini l'articolo). La schermata "Stats" mostra, per ogni alimento, quante volte l'hai comprato, ogni quanti giorni in media e l'ultima volta.
