...
- **Foto dello scontrino**: icona fotocamera in alto nella schermata Lista — scatti una foto dello scontrino della spesa e Gemini (stessa API key) riconosce gli alimenti acquistati e li aggiunge tutti direttamente a "In dispensa" (con categoria e scadenza dedotte automaticamente).
